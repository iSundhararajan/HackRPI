    ...
    return (
        <div>
            <div className="grid place-items-center py-5">
                <div className="flex flex-row text-5xl font-bold text-[#246125]">Add Item <span><img src={LogoImg} width="50" height="50" alt="" /></span></div>
                    ...
                    <div className="relative z-10 flex flex-col items-start justify-start p-10 bg-white shadow-2xl rounded-xl">
                        ...
                        <form className="relative w-full mt-6 space-y-8">
                            ...
                            <div className="relative">
                                ...
                                <input type="number" className="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="365" />
                            </div>
                            <div className="relative">
                            ...
                            <div className="relative">
                                <button className="inline-block w-full px-5 py-4 text-xl font-medium text-center text-white transition duration-200 bg-blue-600 rounded-lg hover:bg-blue-500 ease">Add Item</button>
                            </div>
                        </form>
                    </div>
