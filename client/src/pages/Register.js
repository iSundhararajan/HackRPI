    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="z-20 p-4 m-8 origin-bottom-right transform border-4 border-secondary lg:mx-56 md:mx-8 lg:-mt-80 rounded-2xl bg-gray-200">
                <form onSubmit={registerUser} className="p-4 space-y-10 md:space-y-0 md:grid md:grid-cols-2">
                    ...
                    <div className="md:flex md:flex-col md:justify-center lg:pr-16">
                        ...
                        <div className="relative mt-8 outline-transparent outline">
                            <input type="password" name="password" placeholder=" " className="block w-full pb-2 pl-3 text-lg placeholder-gray-400 bg-transparent border-b-2 border-gray-400 appearance-none rounded-xl focus:border-green-400 focus:outline-none" required value={cPassword}
                                onChange={(e) => setCPassword(e.target.value)} />
                            <label className="absolute top-0 p-2 text-lg duration-300 md:text-lg -z-1 origin-0">Conform Password</label>
                        </div>

                        <div className="grid place-items-center">

                            <button type="submit" className="h-12 px-8 w-full text-base font-semibold tracking-wider text-white border rounded-xl shadow-sm font-fontVollkorn my-6 bg-red-50 bg-gradient-to-r from-purple-400 via-purple-500 to-pink-500 hover:shadow-lg">Sign Up</button>
                        ...
                        <div className='text-right text-lg font-[400] py-2'>Already have an account? <Link to="/login"><span className="text-blue-500 underline">Login</span></Link></div>
